...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/DeepLearningBaselines/RobuSeqNet/slurm_pkg/finetune/inference/microsoft/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/DeepLearningBaselines/RobuSeqNet/slurm_pkg/finetune/inference/microsoft/logs/experiment.err
...
srun \
  ...
  bash -c "
    ...
    python inference.py \
      --checkpoint <your.storage.path>/model_checkpoints_RobuSeqNet/RobuSeqNet_finet_20250626_214422/checkpoint_best_val_loss.pt \
