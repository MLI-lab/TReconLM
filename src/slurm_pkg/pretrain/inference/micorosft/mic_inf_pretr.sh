...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/inference/micorosft/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/inference/micorosft/logs/experiment.err
...
srun -N1 -n1 --nodelist="$NODE_1" \
  ...
  bash -c '
    ...
    # run inference
    torchrun --nproc_per_node=1 src/inference.py exps=micorosft/pretrained_inference
  '
