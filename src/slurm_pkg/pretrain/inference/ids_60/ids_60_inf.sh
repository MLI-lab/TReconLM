...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/inference/ids_60/logs42/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/inference/ids_60/logs42/experiment.err
...
srun -N1 -n1 --nodelist="$NODE_1" \
  ...
  bash -c '
    ...
    # run inference
    torchrun --nproc_per_node=1 --master_port=28147 -m src.inference exps=ids_60
