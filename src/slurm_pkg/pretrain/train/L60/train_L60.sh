...
#SBATCH --gres=gpu:4
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/L60/logs_seed42/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/L60/logs_seed42/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      torchrun --nproc_per_node=4 --master_port=29512 src/pretrain.py exps=ids_60nt/ids_60nt_seed42
     "
