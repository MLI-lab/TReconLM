...
#SBATCH --gres=gpu:4
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/noisy/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/noisy/logs/experiment.err
...
srun -N1 -n1 --nodelist="$NODE_1" \
  ...
  bash -c '
    ...
    # run inference
    torchrun --nproc_per_node=4 --master_port=29501 src/finetune.py exps=noisyDNA/noisy_scratch 
  '
