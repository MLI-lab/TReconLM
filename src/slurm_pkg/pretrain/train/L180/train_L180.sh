...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/L180/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/pretrain/train/L180/logs/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      torchrun --nproc_per_node=1 --master_port=29539 src/pretrain.py exps=ids_180nt/ids_180nt_seed1
     "
