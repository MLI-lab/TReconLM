...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/finetune/inference/microsoft/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/finetune/inference/microsoft/logs/experiment.err
...
srun -N1 -n1 --nodelist="$NODE_1" \
  ...
  bash -c '
    ...
    # run inference
    torchrun --nproc_per_node=1 --master_port=29511 src/inference.py exps=micorosft/finetuned_inference
