...
#SBATCH --gres=gpu:8
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/find_best_target/Nested/logs_trimemd_ag/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/find_best_target/Nested/logs_trimemd_ag/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      python inference_all.py exps=inference/nested
     "
