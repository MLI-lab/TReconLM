...
#SBATCH --gres=gpu:1
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N20/logs_inf/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N20/logs_inf/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      python inference.py exps=inference/fixed_N20
     "
