...
#SBATCH --gres=gpu:2
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N40/logs_inf2/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N40/logs_inf2/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      torchrun --nproc_per_node=2 --master_port=29582 src/inference.py exps=fixedN/fixedN40
     "
