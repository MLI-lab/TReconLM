...
#SBATCH --gres=gpu:4
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N50/logs_inf/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N50/logs_inf/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      torchrun --nproc_per_node=4 --master_port=29588 src/inference.py exps=fixedN/fixedN50
     "
