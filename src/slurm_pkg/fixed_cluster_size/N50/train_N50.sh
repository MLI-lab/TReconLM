...
#SBATCH --gres=gpu:8
#SBATCH -o <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N50/logs/experiment.out
#SBATCH -e <your.slurm.home.path>/TReconLM/src/slurm_pkg/fixed_cluster_size/N50/logs/experiment.err
...
srun -N1 -n1 --nodelist=$NODE_1 \
     ...
     bash -c "
      ...
      torchrun --nproc_per_node=8 src/pretrain.py exps=fixedN/gpt_N50
     "
