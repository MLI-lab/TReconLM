...
Run from repo root: cd /path/to/TReconLM && python -m analysis.plotting.plot_misclustering
"""
...
# TODO: Fill in your baseline values from a clean (no contamination) inference run.
...
from analysis.plot_config import setup_latex_plots, WANDB_ENTITY as ENTITY
