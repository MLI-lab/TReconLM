...
# Run from repo root: cd /path/to/TReconLM && python -m analysis.plotting.plot_openai_comparison
import os
import sys
import numpy as np
...
from analysis.plot_config import (
    setup_latex_plots, ALGO_COLORS, ALGO_MARKERS, ALGO_LABELS,
    WANDB_ENTITY as entity, SAVE_DIR as save_dir, DOWNLOAD_DIR as download_dir,
)
...
project_gpt_mini = "GPTMini"

# Gray color for legend elements (darker than lightgray for better visibility)
GRAY_COLOR = "#777777"

# --- Visual Config (extend shared config with script-specific entries) ---
color_dict = {**ALGO_COLORS, "0-shot": "#CC76D2", "3-shot": "#DA493E", "5-shot": "#F09236"}
marker_dict = {**ALGO_MARKERS, "gpt-4o-mini": "D", "gpt-5": "s"}
label_dict = {**ALGO_LABELS, "Avg. noisy read": None, "Best noisy read": None}
