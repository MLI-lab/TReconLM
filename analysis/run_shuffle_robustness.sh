...
#
# Usage:
#   bash scripts/run_shuffle_robustness.sh NUM_SEEDS [HYDRA_ARGS...]
#   bash scripts/run_shuffle_robustness.sh --aggregate NUM_SEEDS
#
# Examples:
#   bash scripts/run_shuffle_robustness.sh 20 exps=ids_110
#   bash scripts/run_shuffle_robustness.sh 20 exps=ids_110 wandb.wandb_log=false
#   bash scripts/run_shuffle_robustness.sh 10 exps=ids_110 model.checkpoint_path=/path/to/model.pt
#   bash scripts/run_shuffle_robustness.sh --aggregate 20   # re-aggregate existing logs only
