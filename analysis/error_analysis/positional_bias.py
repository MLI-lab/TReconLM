# Run from repo root: cd /path/to/TReconLM && python -m analysis.error_analysis.positional_bias
import csv
import os
import numpy as np
...
from analysis.helpers import get_edit_operations, extract_context

from analysis.plot_config import setup_latex_plots

setup_latex_plots(fontsize=7.7)
